...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/suggestions', [\App\Http\Controllers\Admin\AdminSuggestionsController::class, 'index'])->name('admin.suggestions.index');
    Route::delete('/admin/suggestions/{id}',  [\App\Http\Controllers\Admin\AdminSuggestionsController::class,'deleteSuggestion'])->name('deleteSuggestion');
...
Route::delete('/profile/{id}/remove', [FavoriteController::class, 'remove'])->name('favorites.remove');
