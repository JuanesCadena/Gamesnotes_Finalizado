...
@section('content')
    <body>
        ...
        <h2 style="text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000; margin-bottom: -1rem; margin-top: -4rem">SUGERIR UN VIDEOJUEGO</h2>
        <h5 class="text-white p-4  text-center" style="text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;"> Deja el juego que quieres que añadamos a
