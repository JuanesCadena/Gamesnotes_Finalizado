...
<head>
    ...
    <style>
        ...
        body {
            background: linear-gradient(to bottom, rgba(92, 77, 66, 0.2) 0%, rgba(50, 70, 90, 0.8) 100%), url({{asset('images/color3.jpg')}});
        ...
        .btn-purple:hover {
            background-color: #800080; /* Cambia el color al pasar el ratón por encima */
            border-color: #800080;
        }
    </style>
</head>
...
<div id="sidebar" class="col-md-12 col-lg-12 d-md-block sidebar menu2" style="margin-top: 5rem; margin-bottom: -5rem">
    <div class="position-sticky mx-auto">
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.video_games.index') }}">
                    <p class="text-white btn btn-purple"> Videojuegos</p>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.comments.index') }}">
                    <p class="text-white btn btn-purple">Comentarios</p>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.users.index') }}">
                    <p class="text-white btn btn-purple">Usuarios</p>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.suggestions.index') }}">
                    <p class="text-white btn btn-purple">Sugerencias</p>
                </a>
            </li>
...
<footer class="mt-3">
    <div class="container px-4 px-lg-5">
        <div class=" text-center text-white" style="font-size:x-large;">
            <p class="font-bold">Copyright &copy; 2024 - GamesNotes</p>  </div>
    </div>
</footer>
<!-- Bootstrap core JS-->
