...
@section('content')
    ...
    @if($favorites->isEmpty())
        <h4 class="text-white text-center mt-3 mb-3" style="text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;">No hay juegos favoritos agregados. </h4>
    @else
                ...
                @if(auth()->check() && auth()->user()->id == $user->id)
                    <div class="col-md-12">
                        <div class="comment-box d-flex flex-column justify-content-center align-items-center mx-auto">
                            <p class="text-center" >Aún no has puesto comentarios.</p>
                        </div>
                    </div>
